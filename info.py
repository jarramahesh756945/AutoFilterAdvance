...
BOT_TOKEN = environ.get('BOT_TOKEN', "6457893531:AAFRNIPOrpYAzggcfXhTREdfKl-8LPB8Qhc")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jarramahesh75:JNjCP8ShnEzayS7w@cluster0.tlxbu1j.mongodb.net/?retryWrites=true&w=majority")
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1001509866228')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/hd_top_flix')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/hd_top_flix')
...
URL = "https://admin-cu44.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://admin-cu44.onrender.com/".format(FQDN, PORT)
